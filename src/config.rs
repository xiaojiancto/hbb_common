...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("ChuanYun".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["168.138.43.108"];
pub const RS_PUB_KEY: &str = "YTQEgR0vKrEiOTDsUAEqHnrVxHLHY1chf186klL3W0g=";
